...
Route::prefix('secretaire')->name('secretaire.')->middleware(['auth','role:secretaire'])->group(function () {
    ...
    Route::get('/statistiques/pdf',                       [StatistiquesController::class,'pdf'])->name('statistiques.pdf');
    Route::get('/statistiques/excel',                     [StatistiquesController::class,'excel'])->name('statistiques.excel');
    // États de paiement — routes statiques AVANT {enseignant}
...
Route::prefix('enseignant')->name('enseignant.')->middleware(['auth','role:enseignant'])->group(function () {
    ...
    Route::get('/excel-recap',                            [PaiementController::class,'excelRecapitulatif'])->name('excel-recap');
});
